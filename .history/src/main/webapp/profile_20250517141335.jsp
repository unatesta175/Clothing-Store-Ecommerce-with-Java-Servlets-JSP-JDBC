													...
													<ul class="nav nav-underline fs-9 flex-nowrap mb-3 pb-1"
														...
														<li class="nav-item me-3 "><a
															...
															aria-selected="true"><span class="fas fa-lock me-2"></span>Change
																password</a></li>
														<li class="nav-item me-3"><a
															class="nav-link text-nowrap" id="orders-tab"
														...
														<li class="nav-item me-3"><a
															...
															aria-controls="tab-orders" aria-selected="true"><span
																...
																class="text-body-tertiary fw-normal"> (24)</span></a></li>
														<li class="nav-item "><a class="nav-link text-nowrap"
															id="wishlist-tab" data-bs-toggle="tab"
															href="#tab-wishlist" role="tab"
															aria-controls="tab-orders" aria-selected="true"><span
								...
								<tbody class="list" id="profile-order-table-body">
									<tr
										...
										<td
											...
											12, 12:56 PM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-highlight">RM87</td>
										<td
									...
									<tr
										...
										<td
											...
											9, 2:28PM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-highlight">RM7264</td>
										<td
											class="align-middle text-end white-space-nowrap pe-0 action py-2">
											<div class="btn-reveal-trigger position-static">
												<button
									...
									<tr
										...
										<td
											...
											4, 12:56 PM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-highlight">RM375</td>
										<td
											class="align-middle text-end white-space-nowrap pe-0 action py-2">
											<div class="btn-reveal-trigger position-static">
												<button
									...
									<tr
										...
										<td
											...
											1, 4:07 AM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-highlight">RM657</td>
										<td
											class="align-middle text-end white-space-nowrap pe-0 action py-2">
											<div class="btn-reveal-trigger position-static">
												<button
									...
									<tr
										...
										<td
											...
											28, 7:28 PM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-highlight">RM9562</td>
										<td
											class="align-middle text-end white-space-nowrap pe-0 action py-2">
											<div class="btn-reveal-trigger position-static">
												<button
									...
									<tr
										...
										<td
											...
											24, 10:16 AM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-highlight">RM256</td>
										<td
											class="align-middle text-end white-space-nowrap pe-0 action py-2">
											<div class="btn-reveal-trigger position-static">
												<button
									...
									<tr
										...
										<td
											...
											10, 12:00 PM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-tertiary text-opacity-85">RM898</td>
										<td
											class="align-middle text-end white-space-nowrap pe-0 action py-2">
											<div class="btn-reveal-trigger position-static">
												<button
									...
									<tr
										...
										<td
											...
											12, 12:20 PM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-highlight">RM4116</td>
										<td
											class="align-middle text-end white-space-nowrap pe-0 action py-2">
											<div class="btn-reveal-trigger position-static">
												<button
									...
									<tr
										...
										<td
											...
											19, 1:20 PM</td>
										<td
											class="date align-middle fw-semibold text-end py-2 text-body-tertiary text-opacity-85">RM4116</td>
										<td
											class="align-middle text-end white-space-nowrap pe-0 action py-2">
											<div class="btn-reveal-trigger position-static">
												<button
								...
								<tbody class="list" id="profile-review-table-body">
									<tr
										...
										<td class="align-middle product pe-3"><a
											class="fw-semibold line-clamp-1" href="product-details.html">Jersey
												1</a></td>
								...
								<tbody class="list" id="profile-wishlist-table-body">
									<tr
										...
										<td class="align-middle white-space-nowrap ps-0 py-0"><a
											...
											href="product-details.html"><img
												src="images/jersey-1.png" alt="" width="53" /></a></td>
										...
										<td
											...
											matte black</td>
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">xxl</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM57</td>
										<td
									...
									<tr
										...
										<td class="align-middle white-space-nowrap ps-0 py-0"><a
											class="border border-translucent rounded-2 d-inline-block"
											href="product-details.html"><img
												src="images/jersey-6.png" alt="" width="53" /></a></td>
										<td class="products align-middle pe-11"><a
											class="fw-semibold mb-0 line-clamp-1"
										...
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">xs</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM1,499</td>
										<td
											class="total align-middle fw-bold text-body-highlight text-end text-nowrap pe-0"><button
												class="btn btn-sm text-body-quaternary text-body-tertiary-hover me-2">
												<span class="fas fa-trash"></span>
									...
									<tr
										...
										<td class="align-middle white-space-nowrap ps-0 py-0"><a
											class="border border-translucent rounded-2 d-inline-block"
											href="product-details.html"><img
												src="images/jersey-5.png" alt="" width="53" /></a></td>
										<td class="products align-middle pe-11"><a
											class="fw-semibold mb-0 line-clamp-1"
										...
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">s</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM299</td>
										<td
											class="total align-middle fw-bold text-body-highlight text-end text-nowrap pe-0"><button
												class="btn btn-sm text-body-quaternary text-body-tertiary-hover me-2">
												<span class="fas fa-trash"></span>
									...
									<tr
										...
										<td class="align-middle white-space-nowrap ps-0 py-0"><a
											class="border border-translucent rounded-2 d-inline-block"
											href="product-details.html"><img
												src="images/jersey-4.png" alt="" width="53" /></a></td>
										<td class="products align-middle pe-11"><a
											class="fw-semibold mb-0 line-clamp-1"
										...
										<td
											...
											Gray</td>
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">l</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM1,699</td>
										<td
											class="total align-middle fw-bold text-body-highlight text-end text-nowrap pe-0"><button
												class="btn btn-sm text-body-quaternary text-body-tertiary-hover me-2">
												<span class="fas fa-trash"></span>
									...
									<tr
										...
										<td class="align-middle white-space-nowrap ps-0 py-0"><a
											class="border border-translucent rounded-2 d-inline-block"
											href="product-details.html"><img
												src="images/jersey-3.png" alt="" width="53" /></a></td>
										<td class="products align-middle pe-11"><a
											class="fw-semibold mb-0 line-clamp-1"
										...
										<td
											...
											Blue</td>
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">m</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM65</td>
										<td
											class="total align-middle fw-bold text-body-highlight text-end text-nowrap pe-0"><button
												class="btn btn-sm text-body-quaternary text-body-tertiary-hover me-2">
												<span class="fas fa-trash"></span>
									...
									<tr
										...
										<td class="align-middle white-space-nowrap ps-0 py-0"><a
											class="border border-translucent rounded-2 d-inline-block"
											href="product-details.html"><img
												src="images/jersey-10.png" alt="" width="53" /></a></td>
										<td class="products align-middle pe-11"><a
											class="fw-semibold mb-0 line-clamp-1"
										...
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">s</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM30</td>
										<td
											class="total align-middle fw-bold text-body-highlight text-end text-nowrap pe-0"><button
												class="btn btn-sm text-body-quaternary text-body-tertiary-hover me-2">
												<span class="fas fa-trash"></span>
									...
									<tr
										...
										<td class="align-middle white-space-nowrap ps-0 py-0"><a
											class="border border-translucent rounded-2 d-inline-block"
											href="product-details.html"><img
												src="images/jersey-2.png" alt="" width="53" /></a></td>
										<td class="products align-middle pe-11"><a
											class="fw-semibold mb-0 line-clamp-1"
										...
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">xs</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM40</td>
										<td
											class="total align-middle fw-bold text-body-highlight text-end text-nowrap pe-0"><button
												class="btn btn-sm text-body-quaternary text-body-tertiary-hover me-2">
												<span class="fas fa-trash"></span>
									...
									<tr
										...
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">xxl</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM130</td>
										<td
											class="total align-middle fw-bold text-body-highlight text-end text-nowrap pe-0"><button
												class="btn btn-sm text-body-quaternary text-body-tertiary-hover me-2">
												<span class="fas fa-trash"></span>
									...
									<tr
										...
										<td class="align-middle white-space-nowrap ps-0 py-0"><a
											class="border border-translucent rounded-2 d-inline-block"
											href="product-details.html"><img
												src="images/jersey-17.png" alt="" width="53" /></a></td>
										<td class="products align-middle pe-11"><a
											class="fw-semibold mb-0 line-clamp-1"
										...
										<td
											...
											Gray</td>
										<td
											class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">xl</td>
										<td
											class="price align-middle text-body fs-9 fw-semibold text-end">RM99</td>
										<td
											class="total align-middle fw-bold text-body-highlight text-end text-nowrap pe-0"><button
												class="btn btn-sm text-body-quaternary text-body-tertiary-hover me-2">
												<span class="fas fa-trash"></span>
